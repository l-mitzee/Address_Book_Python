...
def main():
    ...
    while choice >= 1 and choice <= 19:
        ...
        # Sorting entries by city, state or zip code   
        elif(choice == 10):
        ...
        # Writing in text file
            ...
            address_book_collection.write_txt()
            print("Written Successfully")
        
        # Reading Text file
        elif(choice == 14):
            address_book_collection.read_txt()
            print("Successfully read")

        # Writing to csv file
        elif(choice == 15):
            address_book_collection.write_csv()
            print("Written Successfully")

        # Reading from csv file
        elif(choice == 16):
            data = address_book_collection.read_csv()
            print("Successfully read")

        # Writing to json file
        elif(choice == 17):
            address_book_collection.write_json()
            print("Written Successfully")
        # Reading from json file    
        elif(choice == 18):
            address_book_collection.read_json()
